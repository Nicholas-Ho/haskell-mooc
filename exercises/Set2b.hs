...
countdown n = "Ready! "++generateCount "" n++"Liftoff!"
                  where generateCount :: String -> Integer -> String
                        generateCount countStr 0 = countStr
                        generateCount countStr x = generateCount (countStr++show x++"... ") (x-1)
